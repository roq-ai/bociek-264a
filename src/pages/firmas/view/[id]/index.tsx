...
import { getFirmaById } from 'apiSdk/firmas';
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('firma', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/firmas/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/customers/create?firma_id=${data?.id}`}>
