            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>last_name</Th>
                  <Th>email</Th>
                  {hasAccess('firma', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>firma</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>{record.email}</Td>
                    {hasAccess('firma', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/firmas/view/${record.firma?.id}`}>
                          {record.firma?.name}
                        </Link>
                      </Td>
                    )}
